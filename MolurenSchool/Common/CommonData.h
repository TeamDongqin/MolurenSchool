...
// Test user info
#define kMY_USER_ID @"0"
#define kMY_API_KEY @"key0"
#define kMY_USER_PASSWORD @"Test"
#define kMY_USER_DESC @"Test user"
#define kMY_USER_NICKNAME @"Test nick name"
#define kMY_USER_Head @"TestUserPortrait"
#define kMY_USER_LoginName @"TestUserLoginName"
#define kXMPPHost @"120.27.46.123"
#define kXMPPmyJID @"TestXmppJID"
#define kXMPPmyPassword @"TestXmppPassword"
#define kXMPPNewMsgNotifaction @"TestXmppNewMsgNotifaction"
