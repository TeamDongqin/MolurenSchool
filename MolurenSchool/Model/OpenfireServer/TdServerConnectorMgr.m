...
#pragma mark - XMPPStream operations(delegate)
...
- (void)xmppStream:(XMPPStream *)sender didReceiveMessage:(XMPPMessage *)message
{
    ...
    //创建message对象
    TdMessage *msg=[TdMessage messageWithType:kWCMessageTypePlain];
    ...
    if (![TdStudent haveSaveUserById:strs[0]]) {
...
#pragma mark - XMPPRoster operations(delegate)
...
-(void)requestSuccess:(ASIFormDataRequest*)request
{
    ...
    if (resultCode==1) {
        ...
        TdStudent *user=[TdStudent userFromDictionary:dic];
        [TdStudent saveNewUser:user];
    }
